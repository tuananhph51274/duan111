                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <p style="color:red">MOBILESHOP - Hệ Thống 15 Chi Nhánh Bán Lẻ Điện Thoại Trên Toàn Thế Giới </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <ul class="info-list">
                                    <li><a href="http://localhost/duan1-main/duan111/index.php?act=chinhsach">Về Chúng Tôi</a></li>
